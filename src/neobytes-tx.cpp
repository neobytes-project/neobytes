...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("Neobytes Core neobytes-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  neobytes-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded neobytes transaction") + "\n" +
              "  neobytes-tx [options] -create [commands]   " + _("Create hex-encoded neobytes transaction") + "\n" +
              "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded neobytes transaction
