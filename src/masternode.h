...
//
// The Masternode Class. For managing the Darksend process. It contains the input of the 3500 NBY, signature to prove
...
public:
    ...
    /// Is the input associated with collateral public key? (and there is 3500 NBY - checking if valid masternode)
