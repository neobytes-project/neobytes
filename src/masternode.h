...
//
// The Masternode Class. For managing the Darksend process. It contains the input of the 5000 NBY, signature to prove
...
public:
    ...
    /// Is the input associated with collateral public key? (and there is 5000 NBY - checking if valid masternode)
