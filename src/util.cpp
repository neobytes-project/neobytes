...
boost::filesystem::path GetDefaultDataDir()
{
    ...
    // Windows < Vista: C:\Documents and Settings\Username\Application Data\Neobytes
    // Windows >= Vista: C:\Users\Username\AppData\Roaming\Neobytes
    // Mac: ~/Library/Application Support/Neobytes
    // Unix: ~/.neobytes
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Neobytes";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Neobytes";
#else
    // Unix
    return pathRet / ".neobytes";
#endif
#endif
}
...
void ShrinkDebugFile()
{
    ...
    constexpr size_t RECENT_DEBUG_HISTORY_SIZE = 10 * 1000000;Add commentMore actions
