...
#define BOOST_TEST_MODULE Neobytes Test Suite

#include "test_neobytes.h"
...
#endif
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_neobytes_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));
