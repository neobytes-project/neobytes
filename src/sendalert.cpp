...
2. run neobytesd with -printalert or -sendalert like this:
   /path/to/neobytesd -printalert
...
void ThreadSendAlert(CConnman& connman)
{
    ...
    alert.strComment    = "";
    alert.strStatusBar  = "URGENT: Upgrade required: see https://www.neobytes.network";

    // Set specific client version/versions here. If setSubVer is empty, no filtering on subver is done:
    // alert.setSubVer.insert(std::string("/Neobytes Core:0.12.0.58/"));
