...
bool CPrivateSendClient::MakeCollateralAmounts(const CompactTallyItem& tallyItem, bool fTryDenominated, CConnman& connman)
{
    ...
    bool fSuccess = pwalletMain->CreateTransaction(vecSend, wtx, reservekeyChange,
            nFeeRet, nChangePosRet, strFail, &coinControl, true, ONLY_NONDENOMINATED_NOT3500IFMN);
    if(!fSuccess) {
        LogPrintf("CPrivateSendClient::MakeCollateralAmounts -- ONLY_NONDENOMINATED_NOT3500IFMN Error: %s\n", strFail);
        ...
        if(fTryDenominated) {
            ...
            if(!pwalletMain->CreateTransaction(vecSend, wtx, reservekeyChange,
                                nFeeRet, nChangePosRet, strFail, &coinControl, true, ONLY_NOT3500IFMN)) {
                LogPrintf("CPrivateSendClient::MakeCollateralAmounts -- ONLY_NOT3500IFMN Error: %s\n", strFail);
...
void ThreadCheckPrivateSendClient(CConnman& connman)
{
    ...
    RenameThread("neobytes-ps-client");
