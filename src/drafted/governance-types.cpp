...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "NeobytesNetwork") type = NeobytesNetwork;
    if(strType == "NeobytesNetworkVariable") type = NeobytesNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == NeobytesNetwork) s = "NeobytesNetwork";
    if(type == NeobytesNetworkVariable) s = "NeobytesNetworkVariable";
