...
Algorithm for selecting inputs was slightly changed.
...
Detailed [change log](https://github.com/neobytes-project/neobytes/compare/v0.12.1.x...neobytes-project:v0.12.2.x).
...
Neobytes Core tree 0.12.2.x was a fork of Dash Core tree 0.12.2

These release are considered obsolete. Old changelogs can be found here:

- [v0.12.1](release-notes-0.12.1.md) released Jun/??/2021
