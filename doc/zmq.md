...
For instance:
    ...
    $ neobytesd -zmqpubhashtx=tcp://127.0.0.1:28332 \
...
These options can also be provided in neobytes.conf.
...
From the perspective of neobytesd, the ZeroMQ socket is write-only; PUB
sockets don't even have a read function. Thus, there is no state
introduced into neobytesd directly. Furthermore, no information is
